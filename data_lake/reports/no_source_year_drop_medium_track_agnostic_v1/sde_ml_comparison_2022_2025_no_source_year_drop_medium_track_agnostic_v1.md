...
Generated at (UTC): 2026-05-06T14:29:57.513731+00:00
...
## Inputs
- Significance summary: data_lake/reports/no_source_year_drop_medium_track_agnostic_v1/significance_summary_2022_2025_no_source_year_drop_medium_track_agnostic_v1.csv
- Significance tests: data_lake/reports/no_source_year_drop_medium_track_agnostic_v1/significance_tests_2022_2025_no_source_year_drop_medium_track_agnostic_v1.csv
- SDE comparator: data_lake/reports/no_source_year_drop_medium_track_agnostic_v1/heuristic_comparator_2022_2025_no_source_year_drop_medium_track_agnostic_v1.csv
- ML comparator: data_lake/reports/no_source_year_drop_medium_track_agnostic_v1/ml_comparator_2022_2025_no_source_year_drop_medium_track_agnostic_v1.csv

## Headline Comparison
| Model | Actionable | Scored | Excluded | TP | FP | Precision | Wilson CI 95% |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| SDE | 5453 | 486 | 4967 | 305 | 181 | 0.627572 | [0.583747, 0.669396] |
| ML | 206 | 36 | 170 | 22 | 14 | 0.611111 | [0.448645, 0.752151] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | -0.197000 | 0.843827 | tests precision difference on scored rows, ignores pairing |
| mcnemar_cc | overlap_scored_keys_only | 0.000000 | 1 | paired only on shared race driver lap keys, overlap_n=7, discordant=0 |
...
- Precision delta (ML - SDE): -0.016461
- Scored-row delta (ML - SDE): -450
- Actionable-row delta (ML - SDE): -5247
- Scored ratio (ML / SDE): 0.074074
- Actionable ratio (ML / SDE): 0.037777
- Overlap scored keys: 7
- Overlap ratio vs SDE scored: 0.014403, vs ML scored: 0.194444
...
| ML | NO_MATCH_WITHIN_HORIZON | 161 | 0.947059 |
| ML | UNRESOLVED_INCIDENT_FILTER | 6 | 0.035294 |
| ML | UNRESOLVED_MISSING_POST_GAP | 3 | 0.017647 |
...
## Generated Artifacts
- Summary CSV: data_lake/reports/no_source_year_drop_medium_track_agnostic_v1/sde_ml_comparison_summary_2022_2025_no_source_year_drop_medium_track_agnostic_v1.csv
- By-year CSV: data_lake/reports/no_source_year_drop_medium_track_agnostic_v1/sde_ml_comparison_by_year_2022_2025_no_source_year_drop_medium_track_agnostic_v1.csv
