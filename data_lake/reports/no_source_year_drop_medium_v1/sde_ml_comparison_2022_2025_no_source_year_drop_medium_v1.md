...
Generated at (UTC): 2026-05-05T18:43:28.722455+00:00
...
| ML | 188 | 38 | 150 | 20 | 18 | 0.526316 | [0.372590, 0.675210] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | -1.248504 | 0.211846 | tests precision difference on scored rows, ignores pairing |
| mcnemar_cc | overlap_scored_keys_only | 0.000000 | 1 | paired only on shared race driver lap keys, overlap_n=12, discordant=0 |
...
- Precision delta (ML - SDE): -0.102021
- Scored-row delta (ML - SDE): -449
- Actionable-row delta (ML - SDE): -5265
- Scored ratio (ML / SDE): 0.078029
- Actionable ratio (ML / SDE): 0.034476
- Overlap scored keys: 12
- Overlap ratio vs SDE scored: 0.024641, vs ML scored: 0.315789
...
| ML | NO_MATCH_WITHIN_HORIZON | 143 | 0.953333 |
| ML | UNRESOLVED_MISSING_POST_GAP | 5 | 0.033333 |
| ML | UNRESOLVED_INCIDENT_FILTER | 2 | 0.013333 |
