"""Run comparator-invariance audit on merged comparator artifacts.
...
DEFAULT_HEURISTIC = "data_lake/reports/heuristic_comparator_2022_2025_merged.csv"
DEFAULT_ML = "data_lake/reports/ml_comparator_2022_2025_merged.csv"

DEFAULT_SUMMARY_OUTPUT = "data_lake/reports/comparator_invariance_summary_2022_2025_merged.csv"
DEFAULT_DETAILS_OUTPUT = "data_lake/reports/comparator_invariance_details_2022_2025_merged.csv"
DEFAULT_REPORT_OUTPUT = "data_lake/reports/comparator_invariance_report_2022_2025_merged.txt"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="run comparator-invariance audit")
...
def main() -> None:
    ...
    summary_rows.append(
        {
            "check": "comparator_invariance_overall",
    ...
    lines = [
        "=== COMPARATOR-INVARIANCE AUDIT REPORT ===",
