...
Generated at (UTC): 2026-05-01T17:55:47.193634+00:00
...
| ML | 1830 | 258 | 1572 | 235 | 23 | 0.910853 | [0.869788, 0.939862] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | 6.019283 | 1.75191e-09 | tests precision difference on scored rows, ignores pairing |
| mcnemar_cc | overlap_scored_keys_only | 0.000000 | 1 | paired only on shared race driver lap keys, overlap_n=45, discordant=0 |
...
- Precision delta (ML - SDE): 0.176539
- Scored-row delta (ML - SDE): -762
- Actionable-row delta (ML - SDE): -4493
- Scored ratio (ML / SDE): 0.252941
- Actionable ratio (ML / SDE): 0.289420
- Overlap scored keys: 45
- Overlap ratio vs SDE scored: 0.044118, vs ML scored: 0.174419

## Per-Year Comparison
| Year | SDE Scored | SDE Precision | ML Scored | ML Precision | Delta Precision (ML-SDE) | Delta Scored (ML-SDE) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 2022 | 155 | 0.645161 | 68 | 0.779412 | 0.134250 | -87 |
...
| ML | NO_MATCH_WITHIN_HORIZON | 1526 | 0.970738 |
| ML | UNRESOLVED_MISSING_POST_GAP | 24 | 0.015267 |
| ML | UNRESOLVED_INCIDENT_FILTER | 22 | 0.013995 |
