"""run Phase D calibration and decision-policy diagnostics on merged artifacts.
...
DEFAULT_OOF = "data_lake/reports/ml_oof_winner_2022_2024_merged.csv"
DEFAULT_ABLATION = "data_lake/reports/ml_ablation_phase31c_2022_2024_merged.csv"
DEFAULT_SUMMARY_OUTPUT = "data_lake/reports/phase_d_calibration_policy_summary_2022_2024_merged.csv"
DEFAULT_RELIABILITY_OUTPUT = "data_lake/reports/phase_d_calibration_reliability_bins_2022_2024_merged.csv"
DEFAULT_BY_YEAR_OUTPUT = "data_lake/reports/phase_d_policy_by_year_2022_2024_merged.csv"
DEFAULT_BY_FOLD_OUTPUT = "data_lake/reports/phase_d_policy_by_fold_2022_2024_merged.csv"
DEFAULT_REFERENCE_OUTPUT = "data_lake/reports/phase_d_policy_reference_thresholds_2022_2024_merged.csv"
DEFAULT_REPORT_OUTPUT = "data_lake/reports/phase_d_calibration_policy_report_2022_2024_merged.txt"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="run Phase D calibration and decision-policy diagnostics")
...
def main() -> None:
    ...
    lines = [
        "=== PHASE D CALIBRATION AND DECISION-POLICY REPORT ===",
