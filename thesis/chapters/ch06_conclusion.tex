...
The final evaluation showed that these two contracts describe different levels of difficulty. Pit timing can be learned from replayed race context with useful precision
and coverage trade-offs. Successful pit-call prediction can also be evaluated under a strict operational view, but it remains sparse, threshold sensitive, and harder
...
pit cycles from post pit evidence. This gives the thesis a reproducible truth contract, but it does not represent the full utility function of a racing team. A real strategy
...
the strategic outcome, mainly through gap and rival evolution, but it remains an approximation.
...
corrected, or be partially unavailable. The system would need stronger monitoring, latency checks, and failure handling. The evaluation would also have to distinguish
