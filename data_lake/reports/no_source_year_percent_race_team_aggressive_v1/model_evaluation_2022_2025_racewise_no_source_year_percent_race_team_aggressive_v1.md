...
| --- | --- | --- | --- | --- | --- | --- | --- |
| B1 | ML precision delta vs SDE | Checks if ML improves precision under the same comparator semantics. | PASS | precision_delta | 0.053192 | 0.000000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/significance_summary_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
| B2 | Two-proportion z significance | Tests whether observed precision difference is statistically significant. | FAIL | p_value | 0.226882 | 0.050000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/significance_tests_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
| C1 | Reference precision floor | Verifies threshold policy remains at or above the SDE precision floor. | FAIL | reference_precision | 0.615854 | 0.628337 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/threshold_frontier_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
| C2 | Lookahead no-match dominance | Checks that most exclusions are horizon-related, supporting comparator interpretation. | PASS | no_match_rate | 0.953195 | 0.900000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/threshold_frontier_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
| D1 | Constrained precision | Ensures calibrated constrained policy is precise enough for strategy actions. | FAIL | constrained_precision | 0.134984 | 0.600000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/calibration_policy_summary_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
| D2 | Precision-floor reachability | Measures whether candidate thresholds can reliably satisfy precision constraints. | FAIL | reachability_ratio | 0.435675 | 0.900000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/calibration_policy_summary_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
| D3 | Fallback rate | Checks constrained policy stability when precision floor is hard to satisfy. | PASS | fallback_rate | 0.032967 | 0.100000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/calibration_policy_summary_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
...
| G1 | Latency gate | Checks p95 end-to-end inference latency against operational budget. | PASS | latency_p95_total_ms | 5.979114 | 500.000000 | data_lake/reports/no_source_year_percent_race_team_aggressive_v1/live_latency_summary_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv |
...
- Episode comparator files: data_lake/reports/no_source_year_percent_race_team_aggressive_v1/heuristic_comparator_episode_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv, data_lake/reports/no_source_year_percent_race_team_aggressive_v1/ml_comparator_episode_2022_2025_racewise_no_source_year_percent_race_team_aggressive_v1.csv
