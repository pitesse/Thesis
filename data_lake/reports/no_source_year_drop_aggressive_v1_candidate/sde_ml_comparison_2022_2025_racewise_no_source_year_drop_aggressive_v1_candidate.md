...
Generated at (UTC): 2026-05-05T19:09:31.725676+00:00
...
| ML | 2645 | 158 | 2487 | 102 | 56 | 0.645570 | [0.568338, 0.715891] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | 0.390415 | 0.69623 | tests precision difference on scored rows, ignores pairing |
| mcnemar_cc | overlap_scored_keys_only | 0.000000 | 1 | paired only on shared race driver lap keys, overlap_n=26, discordant=0 |
...
- Precision delta (ML - SDE): 0.017233
- Scored-row delta (ML - SDE): -329
- Actionable-row delta (ML - SDE): -2808
- Scored ratio (ML / SDE): 0.324435
- Actionable ratio (ML / SDE): 0.485054
- Overlap scored keys: 26
- Overlap ratio vs SDE scored: 0.053388, vs ML scored: 0.164557

## Per-Year Comparison
| Year | SDE Scored | SDE Precision | ML Scored | ML Precision | Delta Precision (ML-SDE) | Delta Scored (ML-SDE) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 2022 | 136 | 0.632353 | 87 | 0.655172 | 0.022819 | -49 |
...
| ML | NO_MATCH_WITHIN_HORIZON | 2436 | 0.979493 |
| ML | UNRESOLVED_MISSING_POST_GAP | 24 | 0.009650 |
| ML | UNRESOLVED_INCIDENT_FILTER | 23 | 0.009248 |
| ML | UNRESOLVED_MISSING_PRE_GAP | 2 | 0.000804 |
| ML | WEATHER_SURVIVAL_STOP | 2 | 0.000804 |
