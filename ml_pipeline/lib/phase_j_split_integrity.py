"""run phase j split-integrity audit on merged training and oof artifacts.
...
DEFAULT_SUMMARY_OUTPUT = "data_lake/reports/phase_j_split_integrity_summary_2022_2024_merged.csv"
DEFAULT_DETAILS_OUTPUT = "data_lake/reports/phase_j_split_integrity_details_2022_2024_merged.csv"
DEFAULT_REPORT_OUTPUT = "data_lake/reports/phase_j_split_integrity_report_2022_2024_merged.txt"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="run phase j split-integrity audit")
...
def main() -> None:
    ...
    summary_rows.append(
        {
            "check": "phase_j_split_integrity_overall",
    ...
    lines = [
        "=== PHASE J SPLIT-INTEGRITY AUDIT REPORT ===",
