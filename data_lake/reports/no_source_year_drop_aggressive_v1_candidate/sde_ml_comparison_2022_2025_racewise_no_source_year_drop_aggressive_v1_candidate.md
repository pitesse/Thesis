...
Generated at (UTC): 2026-05-01T15:14:03.198467+00:00
...
| ML | 3136 | 402 | 2734 | 358 | 44 | 0.890547 | [0.856252, 0.917449] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | 6.388635 | 1.67373e-10 | tests precision difference on scored rows, ignores pairing |
| mcnemar_cc | overlap_scored_keys_only | 0.000000 | 1 | paired only on shared race driver lap keys, overlap_n=49, discordant=0 |
...
- Precision delta (ML - SDE): 0.156234
- Scored-row delta (ML - SDE): -618
- Actionable-row delta (ML - SDE): -3187
- Scored ratio (ML / SDE): 0.394118
- Actionable ratio (ML / SDE): 0.495967
- Overlap scored keys: 49
- Overlap ratio vs SDE scored: 0.048039, vs ML scored: 0.121891

## Per-Year Comparison
| Year | SDE Scored | SDE Precision | ML Scored | ML Precision | Delta Precision (ML-SDE) | Delta Scored (ML-SDE) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 2022 | 155 | 0.645161 | 87 | 0.643678 | -0.001483 | -68 |
...
| ML | NO_MATCH_WITHIN_HORIZON | 2678 | 0.979517 |
| ML | UNRESOLVED_MISSING_POST_GAP | 32 | 0.011704 |
| ML | UNRESOLVED_INCIDENT_FILTER | 17 | 0.006218 |
| ML | WEATHER_SURVIVAL_STOP | 5 | 0.001829 |
| ML | UNRESOLVED_MISSING_PRE_GAP | 2 | 0.000732 |
