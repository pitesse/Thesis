...
public class LapEvent {
    ...
    public Double getSector1Time() { return sector1Time; }
    @JsonProperty("Sector1Time")
    public void setSector1Time(Double sector1Time) { this.sector1Time = sector1Time; }

    @JsonProperty("Sector2Time")
    public Double getSector2Time() { return sector2Time; }
    @JsonProperty("Sector2Time")
    public void setSector2Time(Double sector2Time) { this.sector2Time = sector2Time; }

    @JsonProperty("Sector3Time")
    public Double getSector3Time() { return sector3Time; }
    @JsonProperty("Sector3Time")
    public void setSector3Time(Double sector3Time) { this.sector3Time = sector3Time; }

    @JsonProperty("Stint")
    public int getStint() { return stint; }
    @JsonProperty("Stint")
    public void setStint(int stint) { this.stint = stint; }
    ...
    @JsonProperty("FreshTyre")
    public void setFreshTyre(boolean freshTyre) { this.freshTyre = freshTyre; }
    ...
    public Double getPitInTime() { return pitInTime; }
    @JsonProperty("PitInTime")
    public void setPitInTime(Double pitInTime) { this.pitInTime = pitInTime; }

    @JsonProperty("PitOutTime")
    public Double getPitOutTime() { return pitOutTime; }
    @JsonProperty("PitOutTime")
    public void setPitOutTime(Double pitOutTime) { this.pitOutTime = pitOutTime; }
    ...
    public Double getGapToCarAhead() { return gapToCarAhead; }
    @JsonProperty("GapToCarAhead")
    public void setGapToCarAhead(Double gapToCarAhead) { this.gapToCarAhead = gapToCarAhead; }
