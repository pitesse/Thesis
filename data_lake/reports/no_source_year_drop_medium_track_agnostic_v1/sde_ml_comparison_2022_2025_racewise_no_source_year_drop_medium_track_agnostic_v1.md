...
Generated at (UTC): 2026-05-05T18:53:01.691672+00:00
...
| ML | 612 | 89 | 523 | 53 | 36 | 0.595506 | [0.491642, 0.691466] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | -0.587732 | 0.556712 | tests precision difference on scored rows, ignores pairing |
...
- Precision delta (ML - SDE): -0.032831
- Scored-row delta (ML - SDE): -398
- Actionable-row delta (ML - SDE): -4841
- Scored ratio (ML / SDE): 0.182752
- Actionable ratio (ML / SDE): 0.112232
- Overlap scored keys: 17
- Overlap ratio vs SDE scored: 0.034908, vs ML scored: 0.191011

## Per-Year Comparison
| Year | SDE Scored | SDE Precision | ML Scored | ML Precision | Delta Precision (ML-SDE) | Delta Scored (ML-SDE) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 2022 | 136 | 0.632353 | 44 | 0.522727 | -0.109626 | -92 |
...
| ML | NO_MATCH_WITHIN_HORIZON | 493 | 0.942639 |
| ML | UNRESOLVED_MISSING_POST_GAP | 16 | 0.030593 |
| ML | UNRESOLVED_INCIDENT_FILTER | 10 | 0.019120 |
| ML | WEATHER_SURVIVAL_STOP | 4 | 0.007648 |
