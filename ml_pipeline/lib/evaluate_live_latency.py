"""Run latency and operational feasibility audit on merged artifacts.
...
DEFAULT_SUMMARY_OUTPUT = "data_lake/reports/live_latency_summary_2022_2025_merged.csv"
DEFAULT_DETAILS_OUTPUT = "data_lake/reports/live_latency_details_2022_2025_merged.csv"
DEFAULT_BY_YEAR_OUTPUT = "data_lake/reports/live_latency_by_year_2022_2025_merged.csv"
DEFAULT_AVAILABILITY_OUTPUT = "data_lake/reports/live_availability_summary_2022_2025_merged.csv"
DEFAULT_OVERHEAD_OUTPUT = "data_lake/reports/live_overhead_comparison_2022_2025_merged.csv"
DEFAULT_REPORT_OUTPUT = "data_lake/reports/live_latency_report_2022_2025_merged.txt"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="run live latency audit")
...
def main() -> None:
    ...
    summary_rows = [
        ...
        {
            "check": "live_latency_overall_gate",
    ...
    report_lines = [
        ...
        "",
        f"overall latency gate   : {_status(overall_pass)}",
        "",
        "artifacts",
