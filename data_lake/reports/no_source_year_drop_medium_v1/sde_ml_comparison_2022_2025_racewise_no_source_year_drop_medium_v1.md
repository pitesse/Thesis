...
Generated at (UTC): 2026-05-01T14:34:30.705318+00:00
...
| ML | 3143 | 400 | 2743 | 351 | 49 | 0.877500 | [0.841731, 0.906087] |

## Statistical Evidence
| Test | Pairing Scope | Statistic | P-value | Note |
| --- | --- | ---: | ---: | --- |
| two_proportion_z | independent_scored_rows | 5.809039 | 6.28324e-09 | tests precision difference on scored rows, ignores pairing |
| mcnemar_cc | overlap_scored_keys_only | 0.000000 | 1 | paired only on shared race driver lap keys, overlap_n=64, discordant=0 |
...
- Precision delta (ML - SDE): 0.143186
- Scored-row delta (ML - SDE): -620
- Actionable-row delta (ML - SDE): -3180
- Scored ratio (ML / SDE): 0.392157
- Actionable ratio (ML / SDE): 0.497074
- Overlap scored keys: 64
- Overlap ratio vs SDE scored: 0.062745, vs ML scored: 0.160000

## Per-Year Comparison
| Year | SDE Scored | SDE Precision | ML Scored | ML Precision | Delta Precision (ML-SDE) | Delta Scored (ML-SDE) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 2022 | 155 | 0.645161 | 98 | 0.653061 | 0.007900 | -57 |
...
| ML | NO_MATCH_WITHIN_HORIZON | 2676 | 0.975574 |
| ML | UNRESOLVED_MISSING_POST_GAP | 35 | 0.012760 |
| ML | UNRESOLVED_INCIDENT_FILTER | 25 | 0.009114 |
| ML | WEATHER_SURVIVAL_STOP | 5 | 0.001823 |
| ML | UNRESOLVED_MISSING_PRE_GAP | 2 | 0.000729 |
